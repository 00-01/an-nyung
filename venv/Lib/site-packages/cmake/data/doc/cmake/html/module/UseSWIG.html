...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>UseSWIG &mdash; CMake 3.20.3 Documentation</title>
...
for example) will be passed on to Python and CSharp wrapper libraries.</p>
</div>
...
<a class="reference internal" href="../manual/cmake-generators.7.html#makefile-generators"><span class="std std-ref">Makefile</span></a> and
<a class="reference internal" href="../manual/cmake-generators.7.html#ninja-generators"><span class="std std-ref">Ninja</span></a> generators. Default value is <code class="docutils literal notranslate"><span class="pre">FALSE</span></code>.</p>
</dd>
