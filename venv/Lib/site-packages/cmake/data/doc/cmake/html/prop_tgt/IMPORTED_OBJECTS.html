...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>IMPORTED_OBJECTS &mdash; CMake 3.20.3 Documentation</title>
...
as well.  The <span class="target" id="index-0-variable:CMAKE_CFG_INTDIR"></span><a class="reference internal" href="../variable/CMAKE_CFG_INTDIR.html#variable:CMAKE_CFG_INTDIR" title="CMAKE_CFG_INTDIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CFG_INTDIR</span></code></a> variable can be a convenient
way of capturing this in combination with the SDK:</p>
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">add_library(</span><span class="nb">someObjs</span><span class="w"> </span><span class="no">OBJECT</span><span class="w"> </span><span class="no">IMPORTED</span><span class="nf">)</span><span class="w"></span>
<span class="nf">set_property(</span><span class="no">TARGET</span><span class="w"> </span><span class="nb">someObjs</span><span class="w"> </span><span class="no">PROPERTY</span><span class="w"> </span><span class="no">IMPORTED_OBJECTS</span><span class="w"></span>
<span class="w">  </span><span class="s">&quot;/path/to/somewhere/${CMAKE_CFG_INTDIR}/$(CURRENT_ARCH)/func.o&quot;</span><span class="w"></span>
<span class="nf">)</span><span class="w"></span>
...
<p>When any Xcode variable or <span class="target" id="index-1-variable:CMAKE_CFG_INTDIR"></span><a class="reference internal" href="../variable/CMAKE_CFG_INTDIR.html#variable:CMAKE_CFG_INTDIR" title="CMAKE_CFG_INTDIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CFG_INTDIR</span></code></a> is used, CMake is
not able to fully evaluate the path(s) at configure time.  One consequence
of this is that the configuration-specific
<span class="target" id="index-1-prop_tgt:IMPORTED_OBJECTS_&lt;CONFIG&gt;"></span><a class="reference internal" href="IMPORTED_OBJECTS_CONFIG.html#prop_tgt:IMPORTED_OBJECTS_&lt;CONFIG&gt;" title="IMPORTED_OBJECTS_&lt;CONFIG&gt;"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">IMPORTED_OBJECTS_&lt;CONFIG&gt;</span></code></a> properties cannot be used, since
CMake cannot determine whether an object file exists at a particular
<code class="docutils literal notranslate"><span class="pre">&lt;CONFIG&gt;</span></code> location.  The <code class="docutils literal notranslate"><span class="pre">IMPORTED_OBJECTS</span></code> property must be used for
these situations and the configuration-specific aspects of the path must be
handled by using <span class="target" id="index-2-variable:CMAKE_CFG_INTDIR"></span><a class="reference internal" href="../variable/CMAKE_CFG_INTDIR.html#variable:CMAKE_CFG_INTDIR" title="CMAKE_CFG_INTDIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CFG_INTDIR</span></code></a> or with another Xcode variable
