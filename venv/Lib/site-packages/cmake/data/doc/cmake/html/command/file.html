...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>file &mdash; CMake 3.20.3 Documentation</title>
...
<a class="reference internal" href="#path-conversion">Path Conversion</a>
  file(<a class="reference internal" href="#real-path">REAL_PATH</a> &lt;path&gt; &lt;out-var&gt; [BASE_DIRECTORY &lt;dir&gt;])
...
<dt><code class="docutils literal notranslate"><span class="pre">REGEX</span> <span class="pre">&lt;regex&gt;</span></code></dt><dd><p>Consider only strings that match the given regular expression.</p>
</dd>
...
that library's own dependencies. Otherwise, resolution proceeds to step 6.</p></li>
...
dependency resolution stops for that dependency.</p></li>
...
recursively resolves that library's own dependencies.</p></li>
</ol>
...
resolved.</p>
<p>If the provided <code class="docutils literal notranslate"><span class="pre">&lt;path&gt;</span></code> is a relative path, it is evaluated relative to the
...
variables <code class="docutils literal notranslate"><span class="pre">CMAKE_TLS_VERIFY</span></code> and <code class="docutils literal notranslate"><span class="pre">CMAKE_TLS_CAINFO</span></code>, respectively.</p>
