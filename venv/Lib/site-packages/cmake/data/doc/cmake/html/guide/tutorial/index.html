...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMake Tutorial &mdash; CMake 3.20.3 Documentation</title>
...
<li><p><a class="reference internal" href="#adding-system-introspection-step-5" id="id12">Adding System Introspection (Step 5)</a></p></li>
...
<li><p><a class="reference internal" href="#packaging-debug-and-release-step-12" id="id19">Packaging Debug and Release (Step 12)</a></p></li>
</ul>
</li>
</ul>
</div>
...
the m library. If <code class="docutils literal notranslate"><span class="pre">log</span></code> and <code class="docutils literal notranslate"><span class="pre">exp</span></code> are not initially found, require the m
library and try again.</p>
...
<p>If available, use <span class="target" id="index-1-command:target_compile_definitions"></span><a class="reference internal" href="../../command/target_compile_definitions.html#command:target_compile_definitions" title="target_compile_definitions"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_compile_definitions()</span></code></a> to specify
...
<h2><a class="toc-backref" href="#id19">Packaging Debug and Release (Step 12)</a><a class="headerlink" href="#packaging-debug-and-release-step-12" title="Permalink to this headline">¶</a></h2>
...
<li><a class="reference internal" href="#adding-system-introspection-step-5">Adding System Introspection (Step 5)</a></li>
