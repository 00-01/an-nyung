...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPack &mdash; CMake 3.20.3 Documentation</title>
...
<code class="docutils literal notranslate"><span class="pre">CPACK_THREADS</span></code> can be set to positive integer to specify how many threads
will be used for compression. If it is set to 0, CPack will set it so that
all available CPU cores are used.
By default <code class="docutils literal notranslate"><span class="pre">CPACK_THREADS</span></code> is set to <code class="docutils literal notranslate"><span class="pre">1</span></code>.</p>
<p>Currently only <code class="docutils literal notranslate"><span class="pre">xz</span></code> compression <em>may</em> take advantage of multiple cores. Other
compression methods ignore this value and use only one thread.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Official CMake binaries available on <code class="docutils literal notranslate"><span class="pre">cmake.org</span></code> ship with a <code class="docutils literal notranslate"><span class="pre">liblzma</span></code>
that does not support parallel compression.</p>
</div>
</dd></dl>
