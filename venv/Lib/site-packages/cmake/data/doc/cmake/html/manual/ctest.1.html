...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ctest(1) &mdash; CMake 3.20.3 Documentation</title>
...
<ul class="simple">
<li><p><a class="reference internal" href="#ctest-1" id="id13">ctest(1)</a></p>
<ul>
<li><p><a class="reference internal" href="#synopsis" id="id14">Synopsis</a></p></li>
<li><p><a class="reference internal" href="#description" id="id15">Description</a></p></li>
<li><p><a class="reference internal" href="#options" id="id16">Options</a></p></li>
<li><p><a class="reference internal" href="#label-and-subproject-summary" id="id17">Label and Subproject Summary</a></p></li>
<li><p><a class="reference internal" href="#build-and-test-mode" id="id18">Build and Test Mode</a></p></li>
<li><p><a class="reference internal" href="#dashboard-client" id="id19">Dashboard Client</a></p>
<ul>
<li><p><a class="reference internal" href="#dashboard-client-steps" id="id20">Dashboard Client Steps</a></p></li>
<li><p><a class="reference internal" href="#dashboard-client-modes" id="id21">Dashboard Client Modes</a></p></li>
<li><p><a class="reference internal" href="#dashboard-client-via-ctest-command-line" id="id22">Dashboard Client via CTest Command-Line</a></p></li>
<li><p><a class="reference internal" href="#dashboard-client-via-ctest-script" id="id23">Dashboard Client via CTest Script</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#dashboard-client-configuration" id="id24">Dashboard Client Configuration</a></p>
<ul>
<li><p><a class="reference internal" href="#ctest-start-step" id="id25">CTest Start Step</a></p></li>
<li><p><a class="reference internal" href="#ctest-update-step" id="id26">CTest Update Step</a></p></li>
<li><p><a class="reference internal" href="#ctest-configure-step" id="id27">CTest Configure Step</a></p></li>
<li><p><a class="reference internal" href="#ctest-build-step" id="id28">CTest Build Step</a></p></li>
<li><p><a class="reference internal" href="#ctest-test-step" id="id29">CTest Test Step</a></p></li>
<li><p><a class="reference internal" href="#ctest-coverage-step" id="id30">CTest Coverage Step</a></p></li>
<li><p><a class="reference internal" href="#ctest-memcheck-step" id="id31">CTest MemCheck Step</a></p></li>
<li><p><a class="reference internal" href="#ctest-submit-step" id="id32">CTest Submit Step</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#show-as-json-object-model" id="id33">Show as JSON Object Model</a></p></li>
<li><p><a class="reference internal" href="#resource-allocation" id="id34">Resource Allocation</a></p>
<ul>
<li><p><a class="reference internal" href="#resource-specification-file" id="id35">Resource Specification File</a></p></li>
<li><p><a class="reference internal" href="#resource-groups-property" id="id36"><code class="docutils literal notranslate"><span class="pre">RESOURCE_GROUPS</span></code> Property</a></p></li>
<li><p><a class="reference internal" href="#environment-variables" id="id37">Environment Variables</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#see-also" id="id38">See Also</a></p></li>
</ul>
</li>
</ul>
</div>
...
<span id="ctest-options"></span><h2><a class="toc-backref" href="#id16">Options</a><a class="headerlink" href="#options" title="Permalink to this headline">¶</a></h2>
<dl>
...
<dt><code class="docutils literal notranslate"><span class="pre">-L</span> <span class="pre">&lt;regex&gt;,</span> <span class="pre">--label-regex</span> <span class="pre">&lt;regex&gt;</span></code></dt><dd><p>Run tests with labels matching regular expression.</p>
