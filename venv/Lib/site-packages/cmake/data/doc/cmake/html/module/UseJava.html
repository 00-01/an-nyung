...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>UseJava &mdash; CMake 3.20.3 Documentation</title>
...
<span class="w">        </span><span class="p">[</span><span class="no">GENERATE_NATIVE_HEADERS</span><span class="w"> </span><span class="nv">&lt;target&gt;</span><span class="w"></span>
<span class="w">                           </span><span class="p">[</span><span class="nf">DESTINATION</span> <span class="nf">(</span><span class="nv">&lt;dir&gt;</span><span class="p">|</span><span class="no">INSTALL</span><span class="w"> </span><span class="nv">&lt;dir&gt;</span><span class="w"> </span><span class="p">[</span><span class="no">BUILD</span><span class="w"> </span><span class="nv">&lt;dir&gt;</span><span class="p">]</span><span class="nf">)</span><span class="p">]]</span><span class="w"></span>
...
<p><span class="versionmodified added">New in version 3.4: </span>Support for response files (prefixed by <code class="docutils literal notranslate"><span class="pre">&#64;</span></code>) in the <code class="docutils literal notranslate"><span class="pre">SOURCES</span></code> list.</p>
</div>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.11: </span>Optionally, using option <code class="docutils literal notranslate"><span class="pre">GENERATE_NATIVE_HEADERS</span></code>, native header files can
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.20: </span><code class="docutils literal notranslate"><span class="pre">DESTINATION</span></code> sub-option now supports the possibility to specify different
output directories for <code class="docutils literal notranslate"><span class="pre">BUILD</span></code> and <code class="docutils literal notranslate"><span class="pre">INSTALL</span></code> steps. This is required to
export the interface target generated by <code class="docutils literal notranslate"><span class="pre">GENERATE_NATIVE_HEADERS</span></code> option.
If <code class="docutils literal notranslate"><span class="pre">BUILD</span></code> directory is not specified, a default directory will be used.</p>
</div>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.20: </span>The target generated by option <code class="docutils literal notranslate"><span class="pre">GENERATE_NATIVE_HEADERS</span></code> has the property
<code class="docutils literal notranslate"><span class="pre">NATIVE_HEADERS_DIRECTORY</span></code> which specify the directory holding the native
headers.</p>
</div>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.9: </span>The <code class="docutils literal notranslate"><span class="pre">NAMESPACE</span></code> option.</p>
</div>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.20: </span>It is now possible to export the target generated by
<code class="docutils literal notranslate"><span class="pre">GENERATE_NATIVE_HEADERS</span></code> option.</p>
...
<li><a class="reference internal" href="#exporting-jar-targets">Exporting JAR Targets</a><ul>
